...
<body>
    ...
    if(isset($_POST['location'])) {
      ...
      $sql = "
      SELECT 
          fd.Fid AS Fid, fd.location AS cure, fd.name,fd.food,fd.category, fd.phoneno, fd.date, 
          fd.delivery_by, fd.address AS From_address,ad.address AS To_address,fd.quantity
      FROM 
          food_donations fd
      LEFT JOIN 
          ngos ad ON fd.assigned_to = ad.NGO_ID 
          WHERE fd.location='$location'
      ";
